        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectiveSubstance = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Pharmacies_PharmacyId",
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "ImageId", "IsDisable", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserAddress", "UserFullName", "UserName" },
                values: new object[] { "59724D2D-E2B5-4C67-AB6F-D93478347B03", 0, "B4555410-F5B0-45B1-B963-1B2351A0723C", "admin@care-capsole.com", true, null, false, false, null, "ADMIN@CARE-CAPSOLE.COM", "ADMIN@CARE-CAPSOLE.COM", "AQAAAAIAAYagAAAAEH5vUuPwuz+jnBJRc15s4RHkT67EMhWV+LptLzFSeFqtBm8ouYhjToihcFkjh+XPZQ==", null, false, "9FABB58491024B7BB140E4D6658B5BDA", false, "lives in CareCapsole", "CareCapsole-Admin", "admin@care-capsole.com" });
